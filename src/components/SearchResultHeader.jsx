...
const SearchResultHeader = () => {
  ...
  return (
    <div className="p-[15px] pb-0 md:pr-5 md:pl-8 md:pt-7 border-b border-[#ebebeb] flex md:block flex-col items-center sticky top-0 bg-white">
      ...
      <div className="flex -ml-36 md:ml-36 mt-3">
        {menu.map((menu, index) => (
          <span
            key={index}
